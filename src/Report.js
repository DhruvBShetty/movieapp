...
// // let obj1=await axios.get('http://${server_addr}/Report1').then(res=>res.data);

// // let obj2=await axios.get('http://${server_addr}/Report2').then(res=>res.data);

// // let obj3=await axios.get('http://${server_addr}/Report3').then(res=>res.data);

// let token=await axios.get("http://${server_addr}/getsession2",{
